	...
	return {
		...
		'init': function(){
			$(document).ready(function(){
				...
				$('.navcontent li').click(function(e){
				...
				var c, currentScrollTop = 0,
					header = $('header'), hamburger = $('.hamburger-menu'), nav = $('.navcontent'), topHeader = $('header, .hamburger-menu');
				...
				$(window).scroll(function(){
					...
					if (c < currentScrollTop && a > b + b) {
						topHeader.addClass("scrollUp");
						if ($(window).width() > 768) {
							$('.navcontent').addClass("scrollUp");
						}
					} else if (c > currentScrollTop && !(a <= b)) {
						topHeader.removeClass("scrollUp");
						if ($(window).width() > 768) {
							$('.navcontent').removeClass("scrollUp");
						}
					}
					c = currentScrollTop;
